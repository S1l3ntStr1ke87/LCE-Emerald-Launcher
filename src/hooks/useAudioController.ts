...
const SPLASHES = [
  ...
  "Better than Bugrock",
  "No microtransactions included!",
  "Who the hell is steve jobs?",
  "Everything You've Ever Dreamed",
  "Xing my box till I 360",
  "Your Mama so fat she broke the 256 block limit in Minecraft",
  "We do not take donations! (we do)",
  "Wait, we're not supposed to exist?",
  "Open Source'nt",
  "What's a Minecraft?",
  "Before GTA VI!",
  "Better than Xenia",
  "Better than RPCS3",
  "Better than Vita3K",
  "Also Try Minecraft Enhanced!",
  "Also Try Minecraft Ultimate!",
  "my dad works at legacy edition",
  "If microsoft pulls us over its yours",
  "Added Herobrine!",
  "Awesome Amazing Splash Text",
  "Mathis Villenave was there",
  "W HMCBE",
  "Thanks neoapps",
];
